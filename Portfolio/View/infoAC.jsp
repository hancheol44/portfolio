  ...
  <div class="centercolumn w3-center">
    <div class="card">
	  ...
	  <div class="detail_card">
	  	<div class="detail">
			<span> 캠핑장 이름 : </span> <span id="acname"></span>&nbsp&nbsp
				<img width="30" height="30" src="/pro/img/icons8-good-quality-64 default.png" alt="Noimg" id="like" value="0"/><span id="likecnt"></span><br><br>
